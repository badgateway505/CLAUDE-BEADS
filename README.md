...
│                                                                 │
│  Claude:                                                        │
│    🔒 Verifies /clear was run (HARD LOCK)                     │
│    📖 Reads ONLY: active bead + context files                 │
│    💻 Executes tasks sequentially                             │
│    ✅ Runs verification (tests/checklist/none)                │
│    💾 Creates atomic commit                                    │
│    📝 Updates ledger with outcome                             │
│    ➡️ Queues next bead                                         │
└─────────────────────────────────────────────────────────────────┘
                            ⬇
┌─────────────────────────────────────────────────────────────────┐
